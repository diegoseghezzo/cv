...
5, building websites for John Deere Latin America (a multi site installation within 50 websites for dealers), fox broadcasting and Game of Thrones. Open to anything between PHP and JS. Currently diving into Python and AI_<br><br>
...
Participating on projects for several clients such as:
  ...
  - **OFX**: React, Context, Typescript, GraphQL, Cypress, Jest, NX, Module Federation, Monorepo, Micro Frontends.
...
- video players, social media integration, bugfixing, using PHP (Symfony, Zend Framework), Java, and Javascript (Vanilla JS).
...
- Infobae: Tech Lead (Drupal 7, JQuery)
- RiskRadius (Drupal 7, JQuery)
- World Fuel Services: Tech lead and coordinator (Drupal 7, JQuery)
- Rimell London (Custom PHP MVC Framework, Salesforce integration)
- StateFarm (Drupal 7, JQuery)
- Razorfish (Custom PHP Solution, Vanilla JS)
...
- Building PHP websites for small / medium clients across USA.

**Fullstack developer** @ [Autologica](https://www.autologica.com/) _(Nov 2008 - May 2010)_ <br>
- Supporting a multi site (60 sites) Drupal 5 solution for John Deere dealers across Latin America.
